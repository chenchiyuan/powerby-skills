...
4. **实现报告（implementation-report.md）**：开发实现报告和测试结果
5. **合并请求（The Pull Request）**：包含代码变更集、开发者测试用例和提交信息

**如何获取上下文**：
当用户触发此skill时，你应该：

1. **请求文档路径**：
   - "请提供以下文档的路径：prd.md, architecture.md, tasks.md, implementation-report.md"
   - 使用 Read 工具读取这些文档
...
请提供以下信息：
1. prd.md 文档路径
2. architecture.md 文档路径
3. tasks.md 文档路径
4. Pull Request 信息（PR链接、分支名称、或代码变更内容）

我将严格按照审计清单对代码进行全面审查，并输出结构化的审计报告。"
