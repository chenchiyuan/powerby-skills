...
**✅ 允许读取的文档**：
- `tasks.md` - 开发任务清单和验收标准
- `architecture.md` - 技术架构设计和组件职责
- 相关代码文件 - 项目现有代码实现

**❌ 严禁读取的文档**：
- `prd.md` - 避免需求描述干扰工程实现
- `clarifications.md` - 避免历史澄清记录造成混乱
- `technical-research.md` - 避免技术调研细节分散注意力
- `constitution.md` - 严禁读取非工程性愿景描述

**⚠️ 重要提醒**：
- 必须以tasks.md的验收标准为准，而非prd.md的原始需求
- architecture.md的组件设计优先级高于prd.md的功能描述
