...
**更新说明**:
- v1.0.0 - 初始版本，四阶段协议
- v1.1.0 - 新增用户确认环节，扩展为七阶段
- v1.2.0 - 单文档记录优化，简化确认流程
- v1.3.0 - 超简化确认格式，仅保留方案和意见
- v1.4.0 - 集成GitHub分支管理，自动化分支操作
...
**输出**: `docs/bugs/global/bug-{id}.md` - 问题报告部分

### 阶段二：诊断分析 (Diagnosis Analysis)
**目标**: 通过证据链分析，快速定位问题根本原因
...
**输出**: `docs/bugs/global/bug-{id}.md` - 诊断分析部分
...
| Gate | 检查要点 | 通过标准 |
|------|----------|----------|
| Gate 1 | 问题报告完整性 | 现象清晰、复现步骤明确 |
| Gate 2 | 诊断分析准确性 | 根因定位准确、影响评估合理 |
